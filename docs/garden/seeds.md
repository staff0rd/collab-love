...
Two packets from The Seed Collection. Both full sun.

## Everlasting Daisy — Mixed ([F7-08](https://theseedcollection.com.au/F7-08))
...
## Chrysanthemum — Rainbow Single Mix ([F1-14](https://theseedcollection.com.au/F1-14))
...
Different temperatures, depths and spacings, so they don't share a strip or a row. The 40-day gap in maturity means one sowing gives two waves of flowers.
